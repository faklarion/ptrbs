...
function renameStatusKapal($currentStatus) {
    // Array untuk mapping status
    $statusMap = [
        '0' => 'Belum Diinput ke Data manapun',
        '1' => 'Masuk',
        '2' => 'Keluar',
        '3' => 'Berlayar',
        '4' => 'Parkir',
    ...
    if (array_key_exists($currentStatus, $statusMap)) {
        return $statusMap[$currentStatus]; // Mengembalikan status baru
    } else {
        return 'Status Tidak Diketahui'; // Jika status tidak ditemukan
    }
}
